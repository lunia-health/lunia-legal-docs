...
<div style="text-align: center; padding: 20px; background: #f8f9fa; border-radius: 8px; margin-bottom: 20px;">
  ...
  <p>
    <a href="en/" style="display: inline-block; padding: 10px 20px; margin: 5px; background: #9b87f5; color: white; text-decoration: none; border-radius: 5px;">📖 English Documentation</a>
    <a href="pt/" style="display: inline-block; padding: 10px 20px; margin: 5px; background: #D946EF; color: white; text-decoration: none; border-radius: 5px;">📖 Documentação Português</a>
  </p>
</div>
